...
<html>
    ...
    <script src="<?php echo $view['assets']->getUrl('bundles/jazzywebdodoc/blueimpFileUpload/js/load-image.min.js') ?>"></script>
    <!-- The Canvas to Blob plugin is included for image resizing functionality -->
    <script src="<?php echo $view['assets']->getUrl('bundles/jazzywebdodoc/blueimpFileUpload/js/canvas-to-blob.min.js') ?>"></script>
